 		        	...
 		        	formatter: function(value,row,index){
 						if (row.clazzId){
 							...
 							for(var i=0;i<clazzList.length;i++ ){
 								...
 								if(row.clazzId == clazzList[i].id)return clazzList[i].bname;
 								}
 						} else {
 							return 'not found';
 						}
			...
			
	    		{
					...
					handler:function(){
						...
						if(!validate){
							...
							var data = {clazzid:clazzid, name:name,sex:sex,mobile:mobile,qq:qq,password:password};
			...
			
	    		{
					...
					handler:function(){
						...
						if(!validate){
							...
							var data = {id:id,clazzid:clazzid, name:name,sex:sex,mobile:mobile,qq:qq};
   		...
   		<form id="addForm" method="post">
	    	<table id="addTable" border=0 style="width:800px; table-layout:fixed;" cellpadding="6" >
	    		<tr>
	    			...
	    			<td colspan="3">
	    				<input id="add_clazzList" style="width: 200px; height: 30px;" class="easyui-textbox" name="clazzid" /></td>
	    			</td>
